...
import { ChatFooter } from 'modules/conference/components/sidebar/chat/footer';
import { Message } from 'modules/conference/components/sidebar/chat/message/message';
